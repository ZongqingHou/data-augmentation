...
class DataAugmentForObjectDetection():
	...
	def dataAugment(self, img, bboxes, aug_num, index):
		'''
		图像增强
		输入:
			img:图像array
...
if __name__ == '__main__':
	...
	for parent, _, files in os.walk(source_pic_root_path):
		for file in files:
			...
			for tmp in range(7):
				auged_img, auged_bboxes = dataAug.dataAugment(img, coords, need_aug_num, tmp)
